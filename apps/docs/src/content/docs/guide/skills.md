...
> **Security note:** `allowed-tools` lists the tools a skill author expects to use. It does not restrict what the skill can call, so enforce authorization in your own tools and approval gates.
